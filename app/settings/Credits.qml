...
Item {
    ...
    ListModel {
        ...
        function initialize() {
            ...
            creditsModel.append({ name: "Maciej Sopyło", title: i18n.tr("Developers"), url: "https://gitlab.com/klhio" })
            creditsModel.append({ name: "Kugi Eusebio", title: i18n.tr("Developers"), url: "https://github.com/kugiigi" })
