...
// HACK: This is a patched version of ListItemStyle.qml from the SDK to work
// around bug #1486008, once this is fixed in the SDK this should be removed
...
Styles.ListItemStyle {
    ...
    property color trailingPanelColor: "Transparent"
