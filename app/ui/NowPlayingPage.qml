...
Page {
    ...
    VisualItemModel {
        ...
        Item {
            ...
            property bool isLandscapeMode: nowPlayingPage.width > nowPlayingPage.height
            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        ...
                        width: nowPlayingPage.width/2.2
                        height: nowPlayingPage.height
                    }
            ...
            BlurredBackground {
                ...
                height: title.lineCount === 1 ? nowPlayingPage.height/2.3 + units.gu(3)
                                              : nowPlayingPage.height/2.3
                art: currentImage

                Image {
                    width: Math.min(nowPlayingPage.width/2, nowPlayingPage.height/2)
                    height: width
    ...
    ListView {
        ...
        anchors {
            top: nowPlayingPage.header.bottom
            left: parent.left
            right: parent.right
            bottom: parent.bottom
        }
        ...
        currentIndex: nowPlayingPageSections.selectedIndex
